(function () {
  ...
  form.addEventListener('submit', function (e) {
    ...
    bundle$1.removeClass(resultsWrapper, 'hidden');
    bundle$1.addClass(results, 'hidden');
    bundle$1.addClass(resultsFooter, 'hidden');
    ...
    aplazame.simulator(currentAmount, { noCache: true, payday: payday }, function (choices) {
      ...
      bundle$1.removeClass(results, 'hidden');
      bundle$1.removeClass(resultsFooter, 'hidden');

      results.innerHTML = bundle$1.template('results', {
        getAmount: bundle$1.getAmount,
        choices: choices,
        months: function (m) {
