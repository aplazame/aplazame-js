...
var cssHack = (function () {
  var cache = {},
    ...
    blur: '@keyframes aplazame-blur{0%{opacity:0;filter:blur(0);-webkit-filter:blur(0)}to{opacity:1;-webkit-filter:blur(3px)}}body.aplazame-blur>:not(.aplazame-modal):not(.aplazame-overlay){animation-duration:.4s;animation-name:aplazame-blur;filter:blur(3px);-webkit-filter:blur(3px)}body.aplazame-unblur>:not(.aplazame-modal):not(.aplazame-overlay){animation-duration:.4s;animation-name:aplazame-blur;animation-direction:reverse}',
