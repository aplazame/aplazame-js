...
module.exports = function checkoutNormalizeAPI(transaction, api_defaults) {
  ...
  transaction_api.public_key = transaction_api.public_key || transaction_api.public_key || merchant.public_api_key || api_defaults.public_key || api_defaults.publicKey;
